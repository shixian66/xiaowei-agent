...
快照标识：`snapshot.m3.starrocks.slow_query.v1`

| capability | version | domain | operation | effect_class | side_effect |
| --- | --- | --- | --- | --- | --- |
| `starrocks.slow_query.diagnose` | `1.0.0` | `starrocks` | `list_slow_queries` | `read` | `false` |
| `starrocks.slow_query.diagnose` | `1.0.0` | `starrocks` | `count_queries_in_window` | `read` | `false` |
