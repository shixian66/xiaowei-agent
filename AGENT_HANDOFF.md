...
| 总体计划 | [DEVELOPMENT_PLAN.md](DEVELOPMENT_PLAN.md) 路线 V3.0；既有 M/W/RI 阶段批准和退出门不变。W3 后续增强延期但未取消，且不作为 W4a/W4b 的进入条件 |
...
3. 新功能路线 F1–F5 已拍板并写入路线规格与 V3.0；当前没有功能实现授权。下一项是 F1 详细计划 → exact-SHA
...
- **新功能路线（用户 2026-09-26 已确认方向，暂缓实施）**：不迁移旧实现、不以“对齐 51 项”为目标。路线为
  ...
  `DEVELOPMENT_PLAN.md` V3.0；方向本身不授权源码、真实连接、部署或 E1。下一步先做 F1 详细计划。
